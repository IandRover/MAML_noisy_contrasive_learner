...
class MetaConvModel(MetaModule):
    ...
    """
    def __init__(self, in_channels, out_features, hidden_size=64, feature_size=64, last=64):
        super(MetaConvModel, self).__init__()
        self.in_channels = in_channels
        self.out_features = out_features
        hidden_size, feature_size = 64, 64
        ...
        self.classifier = MetaLinear(hidden_size*4, out_features, bias=True)
        print(self.classifier.weight.data.shape)
        print(hidden_size, feature_size)
...
def ModelConvOmniglot_last(out_features, hidden_size=64, last=64):
    return MetaConvModel(1, out_features, hidden_size=hidden_size,
                         feature_size=hidden_size, last=last)
