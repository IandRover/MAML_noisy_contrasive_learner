...
from maml.model import ModelConvOmniglot, ModelConvMiniImagenet, ModelMLPSinusoid, ModelConvOmniglot_last
...
#         class_augmentations = [Rotation([90, 180, 270])]
        ...
        model = ModelConvOmniglot_last(num_ways, hidden_size=hidden_size,last=last)
        loss_function = F.cross_entropy
