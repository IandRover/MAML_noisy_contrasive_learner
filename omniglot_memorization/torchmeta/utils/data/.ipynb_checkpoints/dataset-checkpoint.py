...
__all__ = ['ClassDataset', 'MetaDataset', 'CombinationMetaDataset', 'CombinationMetaDataset_no_shuffle']
...
class CombinationMetaDataset_no_shuffle(MetaDataset):
    def __init__(self, dataset, num_classes_per_task, target_transform=None,
        ...
        super(CombinationMetaDataset_no_shuffle, self).__init__(meta_train=dataset.meta_train,
    ...
    def sample_task(self):
        num_per_channel = len(self.dataset)//5
...
#         print("CombinationMetaDataset getitem index", index)
