...
from torchmeta.utils.data import Dataset, ClassDataset, CombinationMetaDataset, CombinationMetaDataset_no_shuffle
from torchvision.datasets.utils import list_dir, download_url
from torchmeta.datasets.utils import get_asset

class Omniglot_no_shuffle(CombinationMetaDataset_no_shuffle):
    def __init__(self, root, num_classes_per_task=None, meta_train=False,
        ...
        dataset = OmniglotClassDataset(root, meta_train=meta_train,
            ...
            download=download)
        super(Omniglot_no_shuffle, self).__init__(dataset, num_classes_per_task,
